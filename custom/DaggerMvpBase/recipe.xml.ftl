...
<recipe>
    ...
    <instantiate from="root/src/app_package/util/Constants.java.ftl"
                   to="${escapeXmlAttribute(utilOut)}/Constants.java" />
    <instantiate from="root/src/app_package/util/DiskIOThreadExecutor.java.ftl"
                   to="${escapeXmlAttribute(utilOut)}/DiskIOThreadExecutor.java" />
